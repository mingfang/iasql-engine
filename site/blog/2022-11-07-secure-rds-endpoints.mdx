...
Please note that you can only use those endpoints from the same region. You can reach the services in multiple regions with the use of <a href="https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html" target="_blank">
VPC peering</a>
